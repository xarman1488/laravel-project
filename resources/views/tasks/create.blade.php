<div style="max-w: 600px; margin: 20px auto; padding: 20px; border: 1px solid #ccc; border-radius: 8px; font-family: sans-serif;">
    <h2 style="margin-bottom: 20px;">Создать новую задачу</h2>
    ...
    <form action="{{ route('tasks.store') }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="title" value="{{ old('title') }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <textarea name="description" rows="4" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">{{ old('description') }}</textarea>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="datetime-local" name="due_date" value="{{ old('due_date') }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
            @error('due_date') <p style="color: red; font-size: 14px; margin: 5px 0 0 0;">{{ $message }}</p> @enderror
        </div>

        <button type="submit" style="background-color: #007bff; color: white; border: none; padding: 10px 15px; border-radius: 4px; cursor: pointer;">Создать задачу</button>
    </form>
</div>
